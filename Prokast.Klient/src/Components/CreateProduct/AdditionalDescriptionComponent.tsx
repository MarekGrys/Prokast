...
const AdditionalDescriptionComponent = ({
    ...
    const updateLocalDescription = (updatedData: AdditionalField) => {
    ...
    console.log("Aktualne opisy:", descriptions);
    useEffect(() => {
                        ...
                        <div className="flex justify-end gap-3 pt-2">
                            <button
                                ...
                                onClick={() => {
                                    ...
                                    removeLocalDescription(selectedDescription.localId);
                                    setIsDeleteOpen(false);
                                    console.log("Aktualne opisy po usunięciu:", descriptions);
                                }}
                                className="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700"
                            >
                                Tak
